...
public class CategoryValidationConstants {
    ...
    public static final String NAME_LENGTH_MESSAGE = "The category name must be between " + MIN_LENGTH_CATEGORY + " and "+NAME_MAX_LENGTH+" characters";
    public static final String DESCRIPTION_LENGTH_MESSAGE = "The category description must be between " + MIN_LENGTH_CATEGORY + " and "+DESCRIPTION_MAX_LENGTH+" characters";
