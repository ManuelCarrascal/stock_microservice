...
public class BrandValidationConstants {
    ...
    public static final String NAME_LENGTH_MESSAGE = "The brand name must be between " + MIN_LENGTH_BRAND + " and "+NAME_MAX_LENGTH+" characters";
    public static final String DESCRIPTION_LENGTH_MESSAGE = "The brand description must be between " + MIN_LENGTH_BRAND + " and "+DESCRIPTION_MAX_LENGTH+" characters";
